							...
							<div class="col-md-7">
								<form action="<?php echo base_url('index.php/accounts/editProfile');?>" method="POST">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="username" value="<?php echo $username;?>" maxlength="25" disabled>
										<?php echo form_error('username'); ?>
									</div>
									<div class="form-group row">
										<div class="col-md-6">
											<label for="password">PASSWORD</label>
											<input type="password" class="form-control" name="password" value="<?php echo $password;?>" maxlength="100">
											<?php echo form_error('password'); ?>
										</div>
										<div class="col-md-6">
											<label for="confirm_password">CONFIRM PASSWORD</label>
											<input type="password" class="form-control"  name="cpass" value="<?php echo $password;?>" maxlength="100">
											<?php echo form_error('cpass'); ?>
										</div>
									</div>
									<div class="form-group">
										<label for="email">EMAIL</label>
										<input type="email" class="form-control"  name="email" value="<?php echo $email;?>" maxlength="100" disabled>
										<?php echo form_error('email'); ?>
									</div>
									<div class="form-group">
										<label for="nickname">NICKNAME</label>
										<input type="text" class="form-control" name="nickname" value="<?php echo $nickname;?>" maxlength="25">
										<?php echo form_error('nickname'); ?>
									</div>
									<div class="form-group row">
										<div class="col-md-5">
											<label for="firstname">FIRST NAME</label>
											<input type="text" class="form-control" name="firstname" value="<?php echo $first_name;?>" maxlength="50">
											<?php echo form_error('firstname'); ?>
										</div>
										<div class="col-md-7">
											<label for="lastname">LAST NAME</label>
											<input type="text" class="form-control" name="lastname" value="<?php echo $last_name;?>" maxlength="50">
											<?php echo form_error('lastname'); ?>
										</div>
									</div>
									<div class="form-group">
										<label for="phone">PHONE</label>
										<input type="text" class="form-control" name="phone" value="<?php echo $phone?>" maxlength="20">
										<?php echo form_error('phone'); ?>
									</div>
									<br>
									<div class="form-group">
										<button type="submit" id="edit_btn" class="btn btn-black2 btn-lg" onclick="edit();">EDIT PROFILE</button>
